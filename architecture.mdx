...
Sindre provides comprehensive meeting intelligence and productivity tools powered by advanced AI and seamless integrations:

<CardGroup cols={2}>
  <Card title="AI-Powered Meeting Intelligence" icon="brain">
  ...
  <Card title="Task Management & Collaboration" icon="list-check">
  ...
  <Card title="Strategic Bet Tracking" icon="target">
  ...
  <Card title="Semantic Search & Discovery" icon="search">
